...
export default abstract class Chart<T extends LWChartOptions> {
  protected constructor (el: HTMLElement, options?: T) {
    ...
    this.createCanvas();
    this.options.addTouchEvent && this.addStartEventHandler();
  }
  ...
  protected mergeOptions (options?: T) {
    ...
    this.options.titleStyle = Object.assign({}, defaultTitleStyle, this.options.titleStyle, options?.titleStyle);
  }
